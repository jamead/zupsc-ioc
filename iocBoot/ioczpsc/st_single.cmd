...
dbLoadRecords("db/brdstats.db", "P=$(IOCNAME), NO=2")
dbLoadRecords("db/status10hz.db", "P=$(IOCNAME), NO=2, OFFSET=100, BUFLEN=10000")
...
#psc1 Create the PSC
createPSC("PSC2", $(PSC1_IP), 3000, 0)
setPSCSendBlockSize("PSC2", 1100, 512)
